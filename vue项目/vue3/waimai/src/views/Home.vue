  ...
  <div class="home">
    ...
    <div class="swiper">
      <van-swipe :autoplay="5000" :loop="false" indicator-color="#fff">
        <van-swipe-item v-for="(image, index) in homeSwiperImg" :key="index">
          <img :src="image">
        </van-swipe-item>
      </van-swipe>
    </div>
...
import FooterBars from '@/components/FooterBar.vue'
import Icons from "@/components/home/icon.vue";
import ScrollNews from "@/components/ScrollNews.vue";
import NewPepole from "@/components/home/NewPepole.vue";
